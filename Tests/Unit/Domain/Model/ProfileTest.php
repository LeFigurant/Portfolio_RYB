...
{
    /**
     * @var \BYR\PortfolioByr\Domain\Model\Profile
     */
    ...
    {
        parent::setUp();
        $this->subject = new \BYR\PortfolioByr\Domain\Model\Profile();
    }
    ...
    {
        $project = new \BYR\PortfolioByr\Domain\Model\Projet();
    ...
    {
        $job = new \BYR\PortfolioByr\Domain\Model\Job();
    ...
    {
        $social = new \BYR\PortfolioByr\Domain\Model\Social();
